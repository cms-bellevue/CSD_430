...
index.jsp - Main dashboard for CRUD operations, optimized for two columns 
to visually spell C-R-U-D.
--%>
...
<body>
    <div class="container">
        ...
        <div class="module-sections-grid">
            ...
            <div class="module-section">
                <h3>❌ DELETE Operations (Module 9)</h3>
                <p>Manage records (soft delete, restore, and permanent delete).</p>
                <ul>
                    <li><a href="module9_delete_select.jsp"><strong>Delete/Restore:</strong> Manage Active and Deleted Records</a></li>
                </ul>
            </div>
